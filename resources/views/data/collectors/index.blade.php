...
@section('content')
    ...
    <p>
        <a href="{{ route('data.collectors.create') }}" class="btn btn-success">@lang('global.app_add_new')</a>
    </p>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped {{ count($collectors) > 0 ? 'datatable' : '' }} dt-select">
                <thead>
                    <tr>
                            ...
                            <tr data-entry-id="{{ $collector->id }}">
                                ...
                                <td>
                                    ...
                                    {!! Form::open(array(
                                        ...
                                        'route' => ['data.collectors.destroy', $collector->id])) !!}
